...
sepCFA.mi = cfa.mi(SEP_model, imputed_mcs2, ordered = c("highest_NVQ", "income_quintiles",
                                            "wealth_quintiles", "occupational_status", "imd"), 
...
SEP1 <- cfa(SEP_model, imputed_mcs2_1, ordered = c("highest_NVQ", "income_quintiles","wealth_quintiles", 
                                                        "occupational_status", "imd"), 
                 std.lv=TRUE, estimator="WLSMV")
