...
mcs1_child_interview <- read_sav("mcs1_cm_interview.sav")
mcs2_child_interview <- read_sav("mcs2_cm_interview.sav")
mcs3_child_interview <- read_sav("mcs3_cm_interview.sav")
mcs5_child_interview <- read_sav("mcs5_cm_interview.sav")
mcs6_child_interview <- read_sav("mcs6_cm_interview.sav")
...
names(mcs1_child_interview) <- tolower(names(mcs1_child_interview))
names(mcs2_child_interview) <- tolower(names(mcs2_child_interview))
names(mcs3_child_interview) <- tolower(names(mcs3_child_interview))
names(mcs5_child_interview) <- tolower(names(mcs5_child_interview))
names(mcs6_child_interview) <- tolower(names(mcs6_child_interview))
