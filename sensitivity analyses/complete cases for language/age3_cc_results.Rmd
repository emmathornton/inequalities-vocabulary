...
age3_cc = long_format_mcs %>% filter(.imp ==0 & !is.na(vocabulary_age3))
age3_complete_cases = long_format_mcs[long_format_mcs$mcsid %in% age3_cc$mcsid,] 
imputed_mcs2 = as.mids(age3_complete_cases)
