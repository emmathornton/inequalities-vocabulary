...
#Get complete cases for age 5 vocabulary 
long_format_mcs = mice::complete(imputed_mcs2, "long", include=TRUE)
age5_cc = long_format_mcs %>% filter(.imp ==0 & !is.na(vocabulary_age5))
age5_complete_cases = long_format_mcs[long_format_mcs$mcsid %in% age5_cc$mcsid,] 
imputed_mcs2 = as.mids(age5_complete_cases)
