...
#Get complete cases for age 3 vocabulary 
long_format_mcs = mice::complete(imputed_mcs2, "long", include=TRUE)
age14_cc = long_format_mcs %>% filter(.imp ==0 & !is.na(vocabulary_age14))
age14_complete_cases = long_format_mcs[long_format_mcs$mcsid %in% age14_cc$mcsid,] 
imputed_mcs2 = as.mids(age14_complete_cases)
