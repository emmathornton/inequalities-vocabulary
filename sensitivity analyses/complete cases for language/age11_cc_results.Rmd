...
#Get complete cases for age 11 vocabulary 
long_format_mcs = mice::complete(imputed_mcs2, "long", include=TRUE)
age11_cc = long_format_mcs %>% filter(.imp ==0 & !is.na(vocabulary_age11))
age11_complete_cases = long_format_mcs[long_format_mcs$mcsid %in% age11_cc$mcsid,] 
imputed_mcs2 = as.mids(age11_complete_cases)
