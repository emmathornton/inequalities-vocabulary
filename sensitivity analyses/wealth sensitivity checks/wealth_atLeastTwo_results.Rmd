...
#Get those who have at least 1 wealth  variable 
long_format_mcs = mice::complete(imputed_mcs2, "long", include=TRUE)
wealth_atLeastTwo = long_format_mcs %>% filter(.imp ==0 & 
                                       (as.numeric(!is.na(savings)) + 
                                          as.numeric(!is.na(mortgage)) +
                                          as.numeric(!is.na(total_debt)) + 
                                          as.numeric(!is.na(house_value)) >=2))
wealth_atLeastTwo_data = long_format_mcs[long_format_mcs$mcsid %in% wealth_atLeastTwo$mcsid,] 
imputed_mcs2 = as.mids(wealth_atLeastTwo_data)
...
#Model comparisons
education_age3 = D1(age3_all_predictors, age3_no_nvq )
income_age3 = D1(age3_all_predictors, age3_no_income)
wealth_age3 = D1(age3_all_predictors, age3_no_wealth)
occupation_age3 = D1(age3_all_predictors, age3_no_occupation )
imd_age3 = D1(age3_all_predictors, age3_no_imd )

#Write results sentence 
#Results
education_age3 = education_age3$result
income_age3 = income_age3$result
wealth_age3 = wealth_age3$result
occupation_age3 = occupation_age3$result
imd_age3 = imd_age3$result
...
education_age5 = D1(age5_all_predictors, age5_no_nvq )
income_age5 = D1(age5_all_predictors, age5_no_income )
wealth_age5 = D1(age5_all_predictors, age5_no_wealth)
occupation_age5 = D1(age5_all_predictors, age5_no_occupation )
imd_age5 = D1(age5_all_predictors, age5_no_imd) 

#Write results sentence 
#Results
education_age5 = education_age5$result
income_age5 = income_age5$result
wealth_age5 = wealth_age5$result
occupation_age5 = occupation_age5$result
imd_age5 = imd_age5$result
...
education_age11 = D1(age11_all_predictors, age11_no_nvq )
income_age11 = D1(age11_all_predictors, age11_no_income )
wealth_age11 = D1(age11_all_predictors, age11_no_wealth)
occupation_age11 = D1(age11_all_predictors, age11_no_occupation )
imd_age11 = D1(age11_all_predictors, age11_no_imd) 

#Write results sentence 
#Results
education_age11 = education_age11$result
income_age11 = income_age11$result
wealth_age11 = wealth_age11$result
occupation_age11 = occupation_age11$result
imd_age11 = imd_age11$result
...
education_age14 = D1(age14_all_predictors, age14_no_nvq )
income_age14 = D1(age14_all_predictors, age14_no_income )
wealth_age14 = D1(age14_all_predictors, age14_no_wealth)
occupation_age14 = D1(age14_all_predictors, age14_no_occupation )
imd_age14 = D1(age14_all_predictors, age14_no_imd) 

#Write results sentence 
#Results
education_age14 = education_age14$result
income_age14 = income_age14$result
wealth_age14 = wealth_age14$result
occupation_age14 = occupation_age14$result
imd_age14 = imd_age14$result

#Write into sentence
paste0("Parent education (Dm(",education_age3[,2],",",round(education_age3[,3],2),")=", round(education_age3[,1],2), ", p=", round(education_age3[,4],3), "), ", 
       "income (Dm(",income_age3[,2],",",round(income_age3[,3],2),")=", round(income_age3[,1],2), ", p=", round(income_age3[,4],3), "), ",
       "wealth (Dm(", wealth_age3[,2],",",round(wealth_age3[,3],2),")=", round(wealth_age3[,1],2), ", p=", round(wealth_age3[,4],3), "),",
      "occupational status (Dm(", occupation_age3[,2],",",round(occupation_age3[,3],2),")=", round(occupation_age3[,1],2), ", p=", round(occupation_age3[,4],3), "),",
      "and relative neighbourhood deprivation (Dm(", imd_age3[,2],",",round(imd_age3[,3],2),")=", round(imd_age3[,1],2), ", p=", round(imd_age3[,4],3), "),",
      "all accounted for significant variance in language ability at age 3.")
#Write into sentence
paste0("Parent education (Dm(",education_age5[,2],",",round(education_age5[,3],2),")=", round(education_age5[,1],2), ", p=", round(education_age5[,4],3), "), ", 
       "income (Dm(",income_age5[,2],",",round(income_age5[,3],2),")=", round(income_age5[,1],2), ", p=", round(income_age5[,4],3), "), ",
       "wealth (Dm(", wealth_age5[,2],",",round(wealth_age5[,3],2),")=", round(wealth_age5[,1],2), ", p=", round(wealth_age5[,4],3), "),",
       "occupational status (Dm(", occupation_age5[,2],",",round(occupation_age5[,3],2),")=", round(occupation_age5[,1],2), ", p=", round(occupation_age5[,4],3), "),",
       "and relative neighbourhood deprivation (Dm(", imd_age5[,2],",",round(imd_age5[,3],2),")=", round(imd_age5[,1],2), ", p=", round(imd_age5[,4],3), "),",
       "all accounted for significant variance in language ability at age 5.")
#Write into sentence
paste0("Parent education (Dm(",education_age11[,2],",",round(education_age11[,3],2),")=", round(education_age11[,1],2), ", p=", round(education_age11[,4],3), "), ", 
       "income (Dm(",income_age11[,2],",",round(income_age11[,3],2),")=", round(income_age11[,1],2), ", p=", round(income_age11[,4],3), "), ",
       "wealth (Dm(", wealth_age11[,2],",",round(wealth_age11[,3],2),")=", round(wealth_age11[,1],2), ", p=", round(wealth_age11[,4],3), "),",
       "occupational status (Dm(", occupation_age11[,2],",",round(occupation_age11[,3],2),")=", round(occupation_age11[,1],2), ", p=", round(occupation_age11[,4],3), "),",
       "and relative neighbourhood deprivation (Dm(", imd_age11[,2],",",round(imd_age11[,3],2),")=", round(imd_age11[,1],2), ", p=", round(imd_age11[,4],3), "),",
       "all accounted for significant variance in language ability at age 11.")
#Write into sentence
paste0("Parent education (Dm(",education_age14[,2],",",round(education_age14[,3],2),")=", round(education_age14[,1],2), ", p=", round(education_age14[,4],3), "), ", 
       "income (Dm(",income_age14[,2],",",round(income_age14[,3],2),")=", round(income_age14[,1],2), ", p=", round(income_age14[,4],3), "), ",
       "wealth (Dm(", wealth_age14[,2],",",round(wealth_age14[,3],2),")=", round(wealth_age14[,1],2), ", p=", round(wealth_age14[,4],3), "), and ",
       "occupational status (Dm(", occupation_age14[,2],",",round(occupation_age14[,3],2),")=", round(occupation_age14[,1],2), ", p=", round(occupation_age14[,4],3),") all accounted for significant variance in language ability at age 14. Relative neighbourhood deprivation did not account for significant variance (Dm(", imd_age14[,2],",",round(imd_age14[,3],2),")=", round(imd_age14[,1],2), ", p=", round(imd_age14[,4],3), ").")
