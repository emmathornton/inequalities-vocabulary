...
wealth_atLeastOne = long_format_mcs %>% filter(.imp ==0 & 
                                       (!is.na(mortgage) | !is.na(house_value) |
                                       !is.na(total_debt) | !is.na(savings)))
wealth_atLeastOne_data = long_format_mcs[long_format_mcs$mcsid %in% wealth_atLeastOne$mcsid,] 
imputed_mcs2 = as.mids(wealth_atLeastOne_data)
...
paste0("Parent education (Dm(",education_age3[,2],",",round(education_age3[,3],2),")=", round(education_age3[,1],2), ", p=", round(education_age3[,4],3), "), ", 
       ...
       "wealth (Dm(", wealth_age3[,2],",",round(wealth_age3[,3],2),")=", round(wealth_age3[,1],2), ", p=", round(wealth_age3[,4],3), "), and ",
       "occupational status (Dm(", occupation_age3[,2],",",round(occupation_age3[,3],2),")=", round(occupation_age3[,1],2), ", p=", round(occupation_age3[,4],3),") all accounted for significant variance in language ability at age 3. Relative neighbourhood deprivation did not account for significant variance (Dm(", imd_age3[,2],",",round(imd_age3[,3],2),")=", round(imd_age3[,1],2), ", p=", round(imd_age3[,4],3), ").")
#Write into sentence
