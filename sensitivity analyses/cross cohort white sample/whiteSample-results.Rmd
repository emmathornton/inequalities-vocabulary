...
#Get White Sample in both cohorts
#MCS
long_format_mcs = mice::complete(mcs_imputation, "long", include=TRUE)
mcs_whiteSample = long_format_mcs %>% filter(.imp ==0 & ethnicity == 0)
mcs_whiteSampleData = long_format_mcs[long_format_mcs$mcsid %in% mcs_whiteSample$mcsid,] 
mcs_imputation = as.mids(mcs_whiteSampleData)


#BCS
long_format_bcs = mice::complete(bcs_imputation, "long", include=TRUE)
bcs_whiteSample = long_format_bcs %>% filter(.imp ==0 & ethnicity == 0)
bcs_whiteSampleData = long_format_bcs[long_format_bcs$bcsid %in% bcs_whiteSample$bcsid,] 
bcs_imputation = as.mids(bcs_whiteSampleData)
...
#age 5
mcs_age5_occupation <- with(mcs_imputation, lm(standardised_vocab5 ~ sex + ethnicity +  EAL + standardised_age5+  occupational_status, weights = weight2)) 
mcs_age5_education <- with(mcs_imputation, lm(standardised_vocab5 ~ sex + ethnicity +  EAL + standardised_age5+ highested1, weights = weight2))
mcs_age5_income <- with(mcs_imputation, lm(standardised_vocab5 ~ sex + ethnicity +  EAL + standardised_age5+ income_quintiles, weights = weight2))
mcs_age5_confounders<- with(mcs_imputation, lm(standardised_vocab5 ~ sex + ethnicity +  EAL + standardised_age5, weights = weight2))

#age 11
mcs_age11_occupation <- with(mcs_imputation, lm(standardised_vocab11 ~ sex + ethnicity +  EAL + standardised_age11+  occupational_status, weights = weight2)) 
mcs_age11_education <- with(mcs_imputation, lm(standardised_vocab11 ~ sex + ethnicity +  EAL + standardised_age11+ highested1, weights = weight2))
mcs_age11_income<- with(mcs_imputation, lm(standardised_vocab11 ~ sex + ethnicity +  EAL + standardised_age11+ income_quintiles, weights = weight2))
mcs_age11_confounders<- with(mcs_imputation, lm(standardised_vocab11 ~ sex + ethnicity +  EAL + standardised_age11,weights = weight2))
#age 14
mcs_age14_occupation <- with(mcs_imputation, lm(standardised_vocab14 ~ sex + ethnicity +  EAL + standardised_age14+  occupational_status,weights = weight2)) 
mcs_age14_education <- with(mcs_imputation, lm(standardised_vocab14 ~ sex + ethnicity +  EAL + standardised_age14+ highested1,weights = weight2))
mcs_age14_income <- with(mcs_imputation, lm(standardised_vocab14 ~ sex + ethnicity +  EAL + standardised_age14+ income_quintiles ,weights = weight2))
mcs_age14_confounders<- with(mcs_imputation, lm(standardised_vocab14 ~ sex + ethnicity +  EAL + standardised_age14,weights = weight2))

#BCS1970 regressions 
bcs_age5_occupation <- with(bcs_imputation, lm(standardised_vocab5 ~ sex + ethnicity +  EAL + standardised_age5+  occupational_status,weights = weight)) 
bcs_age5_education <- with(bcs_imputation, lm(standardised_vocab5 ~ sex + ethnicity +  EAL + standardised_age5+  highestEd1,weights = weight))
bcs_age5_income <- with(bcs_imputation, lm(standardised_vocab5 ~ sex + ethnicity +  EAL + standardised_age5+ oecd_quintiles,weights = weight))
bcs_age5_confounders<- with(bcs_imputation, lm(standardised_vocab5 ~ sex + ethnicity +  EAL + standardised_age5, weights = weight))
#age 10
bcs_age10_occupation <- with(bcs_imputation, lm(standardised_vocab10 ~ sex + ethnicity +  EAL + standardised_age10+  occupational_status, weights = weight)) 
bcs_age10_education <- with(bcs_imputation, lm(standardised_vocab10 ~ sex + ethnicity +   EAL + standardised_age10+  highestEd1, weights = weight))
bcs_age10_income <- with(bcs_imputation, lm(standardised_vocab10 ~ sex + ethnicity +   EAL + standardised_age10+  oecd_quintiles, weights = weight))
bcs_age10_confounders<- with(bcs_imputation, lm(standardised_vocab10 ~ sex + ethnicity +  EAL + standardised_age10, weights = weight))
#age 16
bcs_age16_occupation <- with(bcs_imputation, lm(standardised_vocab16 ~ sex + ethnicity +  EAL + standardised_age16+  occupational_status, weights = weight)) 
bcs_age16_education <- with(bcs_imputation, lm(standardised_vocab16 ~ sex + ethnicity +  EAL + standardised_age16+  highestEd1, weights = weight))
bcs_age16_income <- with(bcs_imputation, lm(standardised_vocab16 ~ sex + ethnicity +  EAL + standardised_age16+  oecd_quintiles, weights = weight))
bcs_age16_confounders<- with(bcs_imputation, lm(standardised_vocab16 ~ sex + ethnicity +  EAL + standardised_age16, weights = weight))
...
mcs_age5_income_results = round(summary(pool(mcs_age5_income), conf.int =TRUE),2)
...
mcs_age11_income_results = round(summary(pool(mcs_age11_income), conf.int =TRUE),2)
...
mcs_age14_income_results = round(summary(pool(mcs_age14_income), conf.int =TRUE),2)
...
bcs_age5_income_results = round(summary(pool(bcs_age5_income), conf.int =TRUE),2)
...
bcs_age10_income_results = round(summary(pool(bcs_age10_income), conf.int =TRUE),2)
...
bcs_age16_income_results = round(summary(pool(bcs_age16_income), conf.int =TRUE),2)
...
MCS_age5_income_results = mcs_age5_income_results[6:9,]
MCS_age11_occupation_results = mcs_age11_occupation_results[6:8,]
MCS_age11_education_results = mcs_age11_education_results[6:8,]
MCS_age11_income_results = mcs_age11_income_results[6:9,]
MCS_age14_occupation_results = mcs_age14_occupation_results[6:8,]
MCS_age14_education_results = mcs_age14_education_results[6:8,]
MCS_age14_income_results = mcs_age14_income_results[6:9,]

BCS_age5_occupation_results = bcs_age5_occupation_results[6:8,]
BCS_age5_education_results = bcs_age5_education_results[6:8,]
BCS_age5_income_results = bcs_age5_income_results[6:9,]
BCS_age10_occupation_results = bcs_age10_occupation_results[6:8,]
BCS_age10_education_results = bcs_age10_education_results[6:8,]
BCS_age10_income_results = bcs_age10_income_results[6:9,]
BCS_age16_occupation_results = bcs_age16_occupation_results[6:8,]
BCS_age16_education_results = bcs_age16_education_results[6:8,]
BCS_age16_income_results = bcs_age16_income_results[6:9,]

MCS_age5_results = rbind(MCS_age5_occupation_results, MCS_age5_education_results, MCS_age5_income_results)
MCS_age11_results = rbind(MCS_age11_occupation_results, MCS_age11_education_results, MCS_age11_income_results)
MCS_age14_results = rbind(MCS_age14_occupation_results, MCS_age14_education_results, MCS_age14_income_results)
BCS_age5_results = rbind(BCS_age5_occupation_results, BCS_age5_education_results, BCS_age5_income_results)
BCS_age10_results = rbind(BCS_age10_occupation_results, BCS_age10_education_results, BCS_age10_income_results)
BCS_age16_results = rbind(BCS_age16_occupation_results, BCS_age16_education_results, BCS_age16_income_results)
```
...
cross_cohort_data = cross_cohort_data  %>% 
  add_row(Indicator= "highest_household_education1",  .before=1) %>% 
  add_row(Indicator= "occupational_status2",  .before=5)  %>% 
  add_row(Indicator= "oecd_quintiles1",  .before=9) 
...
cross_cohort_flex <- cross_cohort_data %>% 
  ...
  set_header_labels(z= " ", Inidcator= "Indicator",early_childhood_bcs= "Early Childhood Vocabulary (BCS)", late_childhood_bcs="Late Childhood Vocabulary (BCS)",
                    ...
                    early_childhood_mcs ="Early Childhood Vocabulary (MCS)", 
                    late_childhood_mcs="Late Childhood Vocabulary (MCS)", 
  ...
  rotate(i=9:13, j=1, rotation="btlr", align="center") %>% 
 print( preview = "docx") 
...
mcs_age5_income_r2 = round(pool.r.squared(mcs_age5_income),4)*100
mcs_age11_income_r2= round(pool.r.squared(mcs_age11_income),4)*100
mcs_age14_income_r2 = round(pool.r.squared(mcs_age14_income),4)*100
...
mcs_age5_income_partial = mcs_age5_income_r2 - mcs_age5_confounders_r2
...
mcs_age11_income_partial = mcs_age11_income_r2 - mcs_age11_confounders_r2
...
mcs_age14_income_partial = mcs_age14_income_r2 - mcs_age14_confounders_r2
...
bcs_age5_income_r2 = round(pool.r.squared(bcs_age5_income),4)*100
bcs_age10_income_r2= round(pool.r.squared(bcs_age10_income),4)*100
bcs_age16_income_r2 = round(pool.r.squared(bcs_age16_income),4)*100
...
bcs_age5_income_partial= bcs_age5_income_r2 - bcs_age5_confounders_r2
...
bcs_age10_income_partial = bcs_age10_income_r2 - bcs_age10_confounders_r2
...
bcs_age16_income_partial= bcs_age16_income_r2 - bcs_age16_confounders_r2


bcs_partial = as.data.frame(rbind(bcs_age5_education_partial,  bcs_age10_education_partial, bcs_age16_education_partial, bcs_age5_occupation_partial, bcs_age10_occupation_partial, bcs_age16_occupation_partial, bcs_age5_income_partial, bcs_age10_income_partial, bcs_age16_income_partial))
mcs_partial = as.data.frame(rbind(mcs_age5_education_partial,  mcs_age11_education_partial, mcs_age14_education_partial, mcs_age5_occupation_partial, mcs_age11_occupation_partial, mcs_age14_occupation_partial, mcs_age5_income_partial, mcs_age11_income_partial, mcs_age14_income_partial))


bcs_partial = bcs_partial %>%  add_column(indicator= c("Parent Education (early bcs)", "Parent education(late bcs)", "parent education (adolescent bcs)", "Occupation (early bcs)", "occupation (late bcs)", "occupation(adolescent bcs)", "Income (early bcs)", "Income (late bcs)", "Income (adolescent bcs)"), .before = 1)
mcs_partial = mcs_partial %>%  add_column(indicator= c("Parent Education (early mcs)", "Parent education(late mcs)", "parent education (adolescent mcs)", "Occupation (early mcs)", "occupation (late mcs)", "occupation(adolescent mcs)", "Income (early mcs)", "Income (late mcs)", "Income (adolescent mcs)"), .before = 1)
...
#add ref category
MCS_age5_education_results= MCS_age5_education_results %>% add_row(term = "highestEd1",  .before=1)
MCS_age5_education_results[is.na(MCS_age5_education_results)] <- 0
MCS_age5_education_results$term[MCS_age5_education_results$term == "highested11"] <- "highestEd11"
MCS_age5_education_results$term[MCS_age5_education_results$term == "highested12"] <- "highestEd12"
MCS_age5_education_results$term[MCS_age5_education_results$term == "highested13"] <- "highestEd13"
MCS_age5_education_results$term[MCS_age5_education_results$term == "highested14"] <- "highestEd14"

BCS_age5_education_results= BCS_age5_education_results %>% add_row(term = "highestEd1",  .before=1)
...
#late childhood education data
#add ref category
MCS_age11_education_results= MCS_age11_education_results %>% add_row(term = "highestEd1",  .before=1)
MCS_age11_education_results[is.na(MCS_age11_education_results)] <- 0
MCS_age11_education_results$term[MCS_age11_education_results$term == "highested11"] <- "highestEd11"
MCS_age11_education_results$term[MCS_age11_education_results$term == "highested12"] <- "highestEd12"
MCS_age11_education_results$term[MCS_age11_education_results$term == "highested13"] <- "highestEd13"
MCS_age11_education_results$term[MCS_age11_education_results$term == "highested14"] <- "highestEd14"
BCS_age10_education_results= BCS_age10_education_results %>% add_row(term = "highestEd1",  .before=1)
...
MCS_age14_education_results= MCS_age14_education_results %>% add_row(term = "highestEd1",  .before=1)
MCS_age14_education_results[is.na(MCS_age14_education_results)] <- 0
MCS_age14_education_results$term[MCS_age14_education_results$term == "highested11"] <- "highestEd11"
MCS_age14_education_results$term[MCS_age14_education_results$term == "highested12"] <- "highestEd12"
MCS_age14_education_results$term[MCS_age14_education_results$term == "highested13"] <- "highestEd13"
MCS_age14_education_results$term[MCS_age14_education_results$term == "highested14"] <- "highestEd14"

BCS_age16_education_results= BCS_age16_education_results %>% add_row(term = "highestEd1",  .before=1)
...
#early childhood income data
#add ref category
MCS_age5_income_results= MCS_age5_income_results %>% add_row(term = "income_quintiles1",  .before=1)
MCS_age5_income_results[is.na(MCS_age5_income_results)] <- 0
BCS_age5_income_results= BCS_age5_income_results %>% add_row(term = "income_quintiles1",  .before=1)
BCS_age5_income_results[is.na(BCS_age5_income_results)] <- 0
BCS_age5_income_results$term[BCS_age5_income_results$term == "oecd_quintiles1"] <- "income_quintiles1"
BCS_age5_income_results$term[BCS_age5_income_results$term == "oecd_quintiles2"] <- "income_quintiles2"
BCS_age5_income_results$term[BCS_age5_income_results$term == "oecd_quintiles3"] <- "income_quintiles3"
BCS_age5_income_results$term[BCS_age5_income_results$term == "oecd_quintiles4"] <- "income_quintiles4"
BCS_age5_income_results$term[BCS_age5_income_results$term == "oecd_quintiles5"] <- "income_quintiles5"
#add cohort
MCS_age5_income_results = MCS_age5_income_results %>%  mutate(cohort = c("MCS2001"))
BCS_age5_income_results = BCS_age5_income_results %>%  mutate(cohort = c("BCS1970"))
#combine cohorts 
early_childhood_income_plotData = rbind(BCS_age5_income_results, MCS_age5_income_results)
#pull out coefficient, 95% CIs and cohort for plot
early_childhood_income_plotData = early_childhood_income_plotData %>% 
  select(term, estimate,  `2.5 %`, `97.5 %` , cohort)

names(early_childhood_income_plotData) <- c("income_quintiles", "vocabulary", "lower_ci", "upper_ci", "cohort")

#late childhood income data
#late childhood income data
#add ref category
MCS_age11_income_results= MCS_age11_income_results %>% add_row(term = "income_quintiles1",  .before=1)
MCS_age11_income_results[is.na(MCS_age11_income_results)] <- 0
BCS_age10_income_results= BCS_age10_income_results %>% add_row(term = "income_quintiles1",  .before=1)
BCS_age10_income_results[is.na(BCS_age10_income_results)] <- 0
BCS_age10_income_results$term[BCS_age10_income_results$term == "oecd_quintiles1"] <- "income_quintiles1"
BCS_age10_income_results$term[BCS_age10_income_results$term == "oecd_quintiles2"] <- "income_quintiles2"
BCS_age10_income_results$term[BCS_age10_income_results$term == "oecd_quintiles3"] <- "income_quintiles3"
BCS_age10_income_results$term[BCS_age10_income_results$term == "oecd_quintiles4"] <- "income_quintiles4"
BCS_age10_income_results$term[BCS_age10_income_results$term == "oecd_quintiles5"] <- "income_quintiles5"
#add cohort
MCS_age11_income_results = MCS_age11_income_results %>%  mutate(cohort = c("MCS2001"))
BCS_age10_income_results = BCS_age10_income_results %>%  mutate(cohort = c("BCS1970"))
#combine cohorts 
late_childhood_income_plotData = rbind(BCS_age10_income_results, MCS_age11_income_results)
#pull out coefficient, 95% CIs and cohort for plot
late_childhood_income_plotData  = late_childhood_income_plotData  %>% 
  select(term, estimate,  `2.5 %`, `97.5 %` , cohort)

names(late_childhood_income_plotData) <- c("income_quintiles", "vocabulary", "lower_ci", "upper_ci", "cohort")

#adolescent income data
MCS_age14_income_results= MCS_age14_income_results %>% add_row(term = "income_quintiles1",  .before=1)
MCS_age14_income_results[is.na(MCS_age14_income_results)] <- 0
BCS_age16_income_results= BCS_age16_income_results %>% add_row(term = "income_quintiles1",  .before=1)
BCS_age16_income_results[is.na(BCS_age16_income_results)] <- 0
BCS_age16_income_results$term[BCS_age16_income_results$term == "oecd_quintiles1"] <- "income_quintiles1"
BCS_age16_income_results$term[BCS_age16_income_results$term == "oecd_quintiles2"] <- "income_quintiles2"
BCS_age16_income_results$term[BCS_age16_income_results$term == "oecd_quintiles3"] <- "income_quintiles3"
BCS_age16_income_results$term[BCS_age16_income_results$term == "oecd_quintiles4"] <- "income_quintiles4"
BCS_age16_income_results$term[BCS_age16_income_results$term == "oecd_quintiles5"] <- "income_quintiles5"

#add cohort
MCS_age14_income_results = MCS_age14_income_results %>%  mutate(cohort = c("MCS2001"))
BCS_age16_income_results = BCS_age16_income_results %>%  mutate(cohort = c("BCS1970"))
#combine cohorts 
adolescent_income_plotData = rbind(BCS_age16_income_results, MCS_age14_income_results)

#pull out coefficient, 95% CIs and cohort for plot
adolescent_income_plotData = adolescent_income_plotData %>% 
  select(term, estimate,  `2.5 %`, `97.5 %` , cohort)
names(adolescent_income_plotData) <- c("income_quintiles", "vocabulary", "lower_ci", "upper_ci", "cohort")
...
education_early_plot <- ggplot(data=early_childhood_education_plotData, aes(x=parent_education, y=vocabulary, group=cohort)) +
  ...
  scale_x_discrete(labels=c("highestEd11" = "No Qualifications \n (Reference)", 
                            "highestEd12" = "O-levels / \n GCSEs", "highestEd13" = "Post-16 \n Qualifications", 
                            "highestEd14" = "University-level \n Qualifications")) +
...
#Income 
income_early_plot <- ggplot(data=early_childhood_income_plotData, aes(x=income_quintiles, y=vocabulary, group=cohort)) +
  geom_line(aes(color=cohort)) +
  geom_ribbon(data=early_childhood_income_plotData,aes(ymin=lower_ci, ymax=upper_ci, fill=cohort),  alpha=0.1 ) + 
  geom_point(aes(color=cohort)) +
  scale_color_manual(name="Cohort", values=c( "#B2ABD2", "#FDB863"), limits=c( "BCS1970", "MCS2001")) +
  scale_fill_manual(name="Cohort", values=c( "#B2ABD2", "#FDB863"), limits=c( "BCS1970", "MCS2001"))+ 
  scale_x_discrete(labels=c("income_quintiles1" = "Quintile 1 \n (Most Deprived) \n (Reference)", 
                            "income_quintiles2" = "Quintile 2", "income_quintiles3" = "Quintile 3", 
                            "income_quintiles4" = "Quintile 4", "income_quintiles5" = "Quintile 5 \n (Least Deprived)")) +
  labs( x = "Income Quintiles", y = "Vocabulary Score \n (standardised)", size = 7) + ylim(0, 1) +
  theme_classic() +
...
#late childhood income

income_late_plot <- ggplot(data=late_childhood_income_plotData, aes(x=income_quintiles, y=vocabulary, group=cohort)) +
  geom_line(aes(color=cohort)) +
  geom_ribbon(data=late_childhood_income_plotData,aes(ymin=lower_ci, ymax=upper_ci, fill=cohort),  alpha=0.1 ) + 
  geom_point(aes(color=cohort)) +
  scale_color_manual(name="Cohort", values=c( "#B2ABD2", "#FDB863"), limits=c( "BCS1970", "MCS2001")) +
  scale_fill_manual(name="Cohort", values=c( "#B2ABD2", "#FDB863"), limits=c( "BCS1970", "MCS2001"))+
  scale_x_discrete(labels=c("income_quintiles1" = "Quintile 1 \n (Most Deprived) \n (Reference)", 
...
income_adolescent_plot <- ggplot(data=adolescent_income_plotData, aes(x=income_quintiles, y=vocabulary, group=cohort)) +
  geom_line(aes(color=cohort)) +
  geom_ribbon(data=adolescent_income_plotData,aes(ymin=lower_ci, ymax=upper_ci, fill=cohort),  alpha=0.1 ) + 
  geom_point(aes(color=cohort)) +
  scale_color_manual(name="Cohort", values=c( "#B2ABD2", "#FDB863"), limits=c( "BCS1970", "MCS2001")) +
  scale_fill_manual(name="Cohort", values=c( "#B2ABD2", "#FDB863"), limits=c( "BCS1970", "MCS2001"))+
  scale_x_discrete(labels=c("income_quintiles1" = "Quintile 1 \n (Most Deprived) \n (Reference)", 
...
income_plots <- ggarrange(income_early_plot, income_late_plot, income_adolescent_plot,
                             labels = c("Early Childhood", "Late Childhood", "Adolescence"), 
                             #label.x=0, label.y=0,
                             font.label = list(size = 13, color = "black", face="italic", family="Times"),
                             hjust= -1,
...
early_childhood = ggarrange(education_early_plot, occupation_early_plot, income_early_plot,
...
late_childhood = ggarrange(education_late_plot, occupation_late_plot, income_late_plot,
                            #labels = c("Early Childhood"), 
                            #hjust = -3, 
                            #font.label = list(size = 7, color = "black", face="bold" ),
                            ncol =3, nrow=1,  align = c( "hv"),
...
adolescence= ggarrange(education_adolescent_plot, occupation_adolescent_plot, income_adolescent_plot,
                           #labels = c("Early Childhood"), 
                           #hjust = -3, 
                           #font.label = list(size = 7, color = "black", face="bold" ),
                           ncol =3, nrow=1,  align = c( "hv"),
...
ggsave("cross-cohort.jpeg", combined_plot, width=18, height=15, units= "in" ,dpi=300)
...
#income
mcsearly_incomePartial =as.data.frame(mcs_age5_income_partial[,1])
mcsearly_incomePartial = mcsearly_incomePartial %>%  add_column(indicator= c("MCS2001 \n Income Quintiles"), .before =1 )
mcsearly_incomePartial = mcsearly_incomePartial %>%  add_column(cohort= c("MCS2001 \n Income Quintiles"), .before =2 )
names(mcsearly_incomePartial) = c("cohort", "indicator", "r2")

bcsearly_incomePartial =as.data.frame(bcs_age5_income_partial[,1])
bcsearly_incomePartial = bcsearly_incomePartial %>%  add_column(indicator= c("BCS1970 \n Income Quintiles"), .before =1 )
bcsearly_incomePartial = bcsearly_incomePartial %>%  add_column(cohort= c("BCS1970 \n Income Quintiles"), .before =2 )
names(bcsearly_incomePartial) = c("cohort", "indicator", "r2")



earlyLang_Partial = rbind(bcsearly_educationPartial, bcsearly_occupationPartial, 
                          bcsearly_incomePartial, mcsearly_educationPartial, 
                          mcsearly_occupationPartial, mcsearly_incomePartial)
...
#income
mcslate_incomePartial =as.data.frame(mcs_age11_income_partial[,1])
mcslate_incomePartial = mcslate_incomePartial %>%  add_column(indicator= c("MCS2001 \n Income Quintiles"), .before =1 )
mcslate_incomePartial = mcslate_incomePartial %>%  add_column(cohort= c("MCS2001 \n Income Quintiles"), .before =2 )
names(mcslate_incomePartial) = c("cohort", "indicator", "r2")

bcslate_incomePartial =as.data.frame(bcs_age10_income_partial[,1])
bcslate_incomePartial = bcslate_incomePartial %>%  add_column(indicator= c("BCS1970 \n Income Quintiles"), .before =1 )
bcslate_incomePartial = bcslate_incomePartial %>%  add_column(cohort= c("BCS1970 \n Income Quintiles"), .before =2 )
names(bcslate_incomePartial) = c("cohort", "indicator", "r2")


lateLang_Partial = rbind(bcslate_educationPartial,bcslate_occupationPartial,
                         bcslate_incomePartial, mcslate_educationPartial,
                         mcslate_occupationPartial, mcslate_incomePartial)
...
#income
mcsadolescent_incomePartial =as.data.frame(mcs_age14_income_partial[,1])
mcsadolescent_incomePartial = mcsadolescent_incomePartial %>%  add_column(indicator= c("MCS2001 \n Income Quintiles"), .before =1 )
mcsadolescent_incomePartial = mcsadolescent_incomePartial %>%  add_column(cohort= c("MCS2001 \n Income Quintiles"), .before =2 )
names(mcsadolescent_incomePartial) = c("cohort", "indicator", "r2")

bcsadolescent_incomePartial =as.data.frame(bcs_age16_income_partial[,1])
bcsadolescent_incomePartial = bcsadolescent_incomePartial %>%  add_column(indicator= c("BCS1970 \n Income Quintiles"), .before =1 )
bcsadolescent_incomePartial = bcsadolescent_incomePartial %>%  add_column(cohort= c("BCS1970 \n Income Quintiles"), .before =2 )
names(bcsadolescent_incomePartial) = c("cohort", "indicator", "r2")


adolescentLang_Partial = rbind(bcsadolescent_educationPartial,bcsadolescent_occupationPartial,
                         bcsadolescent_incomePartial, mcsadolescent_educationPartial,
                         mcsadolescent_occupationPartial, mcsadolescent_incomePartial)
