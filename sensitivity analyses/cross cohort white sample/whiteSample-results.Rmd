...
#age 5
mcs_age5_occupation <- with(mcs_imputation, lm(standardised_vocab5 ~ sex   +  EAL + standardised_age5+  occupational_status, weights = weight2)) 
mcs_age5_education <- with(mcs_imputation, lm(standardised_vocab5 ~ sex   +  EAL + standardised_age5+ highested1, weights = weight2))
mcs_age5_income <- with(mcs_imputation, lm(standardised_vocab5 ~ sex   +  EAL + standardised_age5+ income_quintiles, weights = weight2))
mcs_age5_confounders<- with(mcs_imputation, lm(standardised_vocab5 ~ sex   +  EAL + standardised_age5, weights = weight2))

#age 11
mcs_age11_occupation <- with(mcs_imputation, lm(standardised_vocab11 ~ sex   +  EAL + standardised_age11+  occupational_status, weights = weight2)) 
mcs_age11_education <- with(mcs_imputation, lm(standardised_vocab11 ~ sex   +  EAL + standardised_age11+ highested1, weights = weight2))
mcs_age11_income<- with(mcs_imputation, lm(standardised_vocab11 ~ sex   +  EAL + standardised_age11+ income_quintiles, weights = weight2))
mcs_age11_confounders<- with(mcs_imputation, lm(standardised_vocab11 ~ sex   +  EAL + standardised_age11,weights = weight2))
#age 14
mcs_age14_occupation <- with(mcs_imputation, lm(standardised_vocab14 ~ sex   +  EAL + standardised_age14+  occupational_status,weights = weight2)) 
mcs_age14_education <- with(mcs_imputation, lm(standardised_vocab14 ~ sex   +  EAL + standardised_age14+ highested1,weights = weight2))
mcs_age14_income <- with(mcs_imputation, lm(standardised_vocab14 ~ sex   +  EAL + standardised_age14+ income_quintiles ,weights = weight2))
mcs_age14_confounders<- with(mcs_imputation, lm(standardised_vocab14 ~ sex   +  EAL + standardised_age14,weights = weight2))

#BCS1970 regressions 
bcs_age5_occupation <- with(bcs_imputation, lm(standardised_vocab5 ~ sex   +  EAL + standardised_age5+  occupational_status,weights = weight)) 
bcs_age5_education <- with(bcs_imputation, lm(standardised_vocab5 ~ sex   +  EAL + standardised_age5+  highestEd1,weights = weight))
bcs_age5_income <- with(bcs_imputation, lm(standardised_vocab5 ~ sex   +  EAL + standardised_age5+ oecd_quintiles,weights = weight))
bcs_age5_confounders<- with(bcs_imputation, lm(standardised_vocab5 ~ sex   +  EAL + standardised_age5, weights = weight))
#age 10
bcs_age10_occupation <- with(bcs_imputation, lm(standardised_vocab10 ~ sex   +  EAL + standardised_age10+  occupational_status, weights = weight)) 
bcs_age10_education <- with(bcs_imputation, lm(standardised_vocab10 ~ sex   +   EAL + standardised_age10+  highestEd1, weights = weight))
bcs_age10_income <- with(bcs_imputation, lm(standardised_vocab10 ~ sex   +   EAL + standardised_age10+  oecd_quintiles, weights = weight))
bcs_age10_confounders<- with(bcs_imputation, lm(standardised_vocab10 ~ sex   +  EAL + standardised_age10, weights = weight))
#age 16
bcs_age16_occupation <- with(bcs_imputation, lm(standardised_vocab16 ~ sex   +  EAL + standardised_age16+  occupational_status, weights = weight)) 
bcs_age16_education <- with(bcs_imputation, lm(standardised_vocab16 ~ sex   +  EAL + standardised_age16+  highestEd1, weights = weight))
bcs_age16_income <- with(bcs_imputation, lm(standardised_vocab16 ~ sex   +  EAL + standardised_age16+  oecd_quintiles, weights = weight))
bcs_age16_confounders<- with(bcs_imputation, lm(standardised_vocab16 ~ sex   +  EAL + standardised_age16, weights = weight))
