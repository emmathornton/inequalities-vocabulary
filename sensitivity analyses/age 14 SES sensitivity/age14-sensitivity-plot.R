...
NVQ_plot <- data.frame(
  ...
  language = c(0, 0.15, 0.26, 0.55, 0.93, 
               0, 0.18, 0.30, 0.52, 0.68),
  lower_ci_nvq = c(0,0.06 , 0.16, 0.46 , 0.82, 
                   0, 0.09, 0.21, 0.43, 0.59),
  upper_ci_nvq = c(0, 0.24, 0.35, 0.64, 1.03,
                   0,0.26, 0.39, 0.60, 0.77),
...
income_plot <- data.frame(
  Income_Quintiles = factor(c("Lowest \n Quintile", "2", "3", "4", "Highest \n Quintile"), 
                            levels=c("Lowest \n Quintile", "2", "3", "4", "Highest \n Quintile")),
  language = c(0, 0.13, 0.28, 0.45, 0.69,

               0, 0.13, 0.33, 0.50, 0.74  ),
  lower_ci_income = c(0,  0.07, 0.22, 0.39, 0.63,
                      0, 0.07, 0.28, 0.44, 0.68
                    ),
  upper_ci_income = c(0, 0.19, 0.34, 0.51, 0.75,
                      0, 0.19, 0.39, 0.56, 0.80),
...
wealth_plot <- data.frame(
  wealth = factor(c("Lowest \n Quintile", "2", "3", "4", "Highest \n Quintile"), 
                  levels=c("Lowest \n Quintile", "2", "3", "4", "Highest \n Quintile")),
  language = c(0, 0.02, 0.10, 0.17, 0.41,
               
               0,  0.02, 0.09, 0.21, 0.45
               
               
  ),
  lower_ci_wealth = c(0, -0.05, 0.02, 0.09, 0.35,
                      
                      0, -0.07, -0.00, 0.13, 0.37
                      
  ),
  upper_ci_wealth = c(0, 0.09, 0.17, 0.24, 0.48, 
                      
                      0, 0.11, 0.19, 0.30, 0.53
...
occupation_plot <- data.frame(
  ...
  language = c(0,  0.12, 0.45,
              
               0, 0.19, 0.41),
  lower_ci_occupation = c( 0, 0.06, 0.40 , 
                           
                           0, 0.13, 0.36),
  upper_ci_occupation = c(0, 0.17, 0.50,
...
imd_plot <- data.frame(
  imd_decile = factor(c("Most \n Deprived", "2", "3", "4", "5", 
                      ...
                      levels=c("Most \n Deprived", "2", "3", "4", "5", 
                               "6", "7", "8", "9", "Least \n Deprived")),
  language = c(0, 0.11, 0.18, 0.22, 0.25, 0.29, 0.37, 0.47, 0.46, 0.57, 
               0, 0.10, 0.14, 0.24, 0.29, 0.36, 0.46, 0.43, 0.50, 0.66),
  lower_ci_imd = c(0, 0.03, 0.10, 0.14, 0.18, 0.21, 0.28, 0.39, 0.38, 0.49,
                   0, 0.03, 0.06, 0.16, 0.21, 0.28, 0.38, 0.35, 0.42, 0.58 
  ),
  upper_ci_imd = c(0, 0.18, 0.26, 0.29, 0.33, 0.36, 0.46, 0.54, 0.54, 0.65,
                   0, 0.18, 0.21, 0.32, 0.37, 0.44, 0.54, 0.51, 0.58, 0.74),
...
NVQ_plot <- data.frame(
  ...
  language = c(0, 0.20, 0.34, 0.58, 0.74, 
               0, 0.24, 0.37, 0.66, 0.89, 
               0, 0.16, 0.32, 0.55, 0.80, 
               0, 0.15, 0.26, 0.55, 0.93, 
               0, 0.18, 0.30, 0.52, 0.68),
  lower_ci_nvq = c(0,0.13, 0.27, 0.52, 0.66, 
                   0, 0.1, 0.29, 0.59, 0.81,
                   0, 0.08, 0.22, 0.46, 0.70,
                   0, 0.06, 0.16, 0.46, 0.82,
                   0, 0.09, 0.21, 0.43, 0.59
  ),
  upper_ci_nvq = c(0, 0.26, 0.41, 0.65, 0.82, 
                   0, 0.31, 0.44, 0.73, 0.98, 
                   0, 0.25, 0.41, 0.64, 0.90,
...
income_plot <- data.frame(
  Income_Quintiles = factor(c("Lowest \n Quintile", "2", "3", "4", "Highest \n Quintile"),
                            levels=c("Lowest \n Quintile", "2", "3", "4", "Highest \n Quintile")),
  language = c(0, 0.16, 0.40, 0.56, 0.67,
               0, 0.16, 0.43, 0.57, 0.76, 
               0, 0.13, 0.32, 0.46, 0.66,
               0, 0.13, 0.28, 0.45, 0.69, 
               0, 0.13, 0.33, 0.50, 0.74 
  ),
  lower_ci_income = c(0, 0.12, 0.35, 0.52, 0.62, 
                      0, 0.12, 0.38, 0.53, 0.72, 
                      0, 0.08, 0.27, 0.4, 0.61, 
                      0, 0.07, 0.22, 0.39, 0.63, 
                      0, 0.07, 0.28, 0.44, 0.68),
  upper_ci_income = c(0, 0.20, 0.44, 0.61, 0.71, 
                      0, 0.21, 0.47, 0.62, 0.81, 
                      0, 0.18, 0.37, 0.51, 0.71,
                      0, 0.19, 0.34, 0.51, 0.75,
                      0, 0.19, 0.39, 0.56, 0.80),
  age = factor(c("Age 3", "Age 3", "Age 3", "Age 3", "Age 3", 
                 "Age 5", "Age 5", "Age 5", "Age 5", "Age 5",
                 "Age 11", "Age 11", "Age 11", "Age 11", "Age 11",
...
wealth_plot <- data.frame(
  wealth = factor(c("Lowest \n Quintile", "2", "3", "4", "Highest \n Quintile"), 
                  levels=c("Lowest \n Quintile", "2", "3", "4", "Highest \n Quintile")),
  language = c(0, 0.03, 0.09, 0.18, 0.33,
               0, 0.02, 0.09, 0.20, 0.40, 
               0, 0.03, 0.09, 0.18, 0.37, 
               0, 0.02, 0.10, 0.17, 0.41, 
               0,  0.02, 0.09, 0.21, 0.45
               
               
  ),
  lower_ci_wealth = c(0, -0.03, 0.02, 0.12, 0.27, 
                      0, -0.05, 0.02, 0.13, 0.34, 
                      0, -0.05, 0.02, 0.11, 0.29, 
                      0, -0.05, 0.02, 0.09, 0.35, 
                      0, -0.07, -0.00, 0.13, 0.37
                      
  ),
  upper_ci_wealth = c(0, 0.10, 0.16, 0.24, 0.40, 
                      0, 0.09, 0.16, 0.26, 0.46, 
                      0, 0.11, 0.16, 0.26, 0.46, 
                      0, 0.09, 0.17, 0.24, 0.48, 
                      0, 0.11, 0.19, 0.30, 0.53
...
imd_plot <- data.frame(
  imd_decile = factor(c("Most \n Deprived", "2", "3", "4", "5", 
                      ...
                      levels=c("Most \n Deprived", "2", "3", "4", "5", 
                               "6", "7", "8", "9", "Least \n Deprived")),
  language = c(0, 0.11, 0.18, 0.27, 0.29, 0.36, 0.44, 0.49, 0.49, 0.60, 
               0, 0.10, 0.23, 0.28, 0.33, 0.41, 0.47, 0.57, 0.57, 0.68, 
               0, 0.19, 0.24, 0.32, 0.32, 0.37, 0.49, 0.49, 0.50, 0.63, 
               0, 0.11, 0.18, 0.22, 0.25, 0.29, 0.37, 0.47, 0.46, 0.57, 
               0, 0.10, 0.14, 0.24, 0.29, 0.36, 0.46, 0.43, 0.50, 0.66
  ),
  lower_ci_imd = c(0, 0.05, 0.12, 0.21, 0.23, 0.30, 0.38, 0.43, 0.43, 0.54,
                   0, 0.04, 0.16, 0.22, 0.27, 0.35, 0.40, 0.50, 0.50, 0.62, 
                   0, 0.11, 0.16, 0.24, 0.24, 0.30, 0.41, 0.41, 0.42, 0.55, 
                   0, 0.03, 0.10, 0.14, 0.18, 0.21, 0.28, 0.39, 0.38, 0.49, 
                   0, 0.03, 0.06, 0.16, 0.21, 0.28, 0.38, 0.35, 0.42, 0.58 
                   
                   
                   
  ),
  upper_ci_imd = c(0, 0.17, 0.24, 0.34, 0.35, 0.42, 0.50, 0.55, 0.55, 0.66, 
                   0, 0.16, 0.29, 0.34, 0.39, 0.47, 0.53, 0.63, 0.63, 0.75, 
                   0, 0.27, 0.32, 0.40, 0.40, 0.44, 0.58, 0.56, 0.57, 0.70, 
                   0, 0.18, 0.26, 0.29, 0.22, 0.26, 0.46, 0.54, 0.54, 0.65, 
                   0, 0.18, 0.21, 0.32, 0.37, 0.44, 0.54, 0.51, 0.58, 0.74
