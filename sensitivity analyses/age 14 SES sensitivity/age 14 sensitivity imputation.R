...
#recode occupational status 
long_format_mcs$occupational_status <- with(long_format_mcs, rec(occupational_status,  rec = "1=4; 2=3; 3=2; 4=1", as.num = TRUE, var.label = NULL, val.labels = NULL, append = FALSE, suffix = "_r"))
